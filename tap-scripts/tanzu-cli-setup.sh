...
# install tanzu cli v(0.12.0) and plug-ins (linux)
#url linux-  tanzu cli -  - https://network.pivotal.io/api/v2/products/tanzu-application-platform/releases/1078790/product_files/1190781/download
#url mac- tanzu cli - https://network.pivotal.io/api/v2/products/tanzu-application-platform/releases/1078790/product_files/1190780/download

#file name - mac= tanzu-framework-darwin-amd64.tar , linux= tanzu-framework-linux-amd64.tar


tanzucliurl=https://network.pivotal.io/api/v2/products/tanzu-application-platform/releases/1078790/product_files/1190780/download
...
tanzucliurl=https://network.pivotal.io/api/v2/products/tanzu-application-platform/releases/1078790/product_files/1190781/download
